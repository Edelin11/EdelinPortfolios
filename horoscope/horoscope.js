...
const forAries =()=>{
    ...
    if(getDay <= 31 && getMonth == aries[0] && getDay >= aries[1] || getMonth[0] == aries[2] &&  getDay <= aries[3] ){
        result.innerHTML = `<p style="font-size: 20px; font-weight: bold;">Aries ${'<br>'} March 21 - April 19</p>`;
        more.innerHTML = `
        ...
        ${'<br>'}${'<br>'}<h5 style="font-weight: bold; font-style: italic;">Personality Traits:</h5>
        ...
        ${'<br>'}${'<br>'}<h5 style="font-weight: bold; font-style: italic;">Negative Traits:</h5>
        ...
        ${'<br>'}${'<br>'}<h5 style="font-weight: bold; font-style: italic;">In Love:</h5>
        ...
        ${'<br>'}${'<br>'}<h5 style="font-weight: bold; font-style: italic;">In the Tarot:</h5>
...
const forTaurus =()=>{
    ...
    if(getDay <= 30 && getMonth == taurus[0] && getDay >= taurus[1] || getMonth[0] == taurus[2] && getDay <= taurus[3] ){
        result.innerHTML = `<p style="font-size: 20px; font-weight: bold;">Taurus ${'<br>'} April 20 - May 20</p>`;
        more.innerHTML = `
...
const forGemini =()=>{
    ...
    if(getDay <= 31 && getMonth == gemini[0] && getDay >= gemini[1] || getMonth[0] == gemini[2] && getDay <= gemini[3]){
        result.innerHTML = `<p style="font-size: 20px; font-weight: bold;">Gemini ${'<br>'} May 21 - June 20</p>`;
        more.innerHTML = `
...
const forCancer =()=>{
    ...
    if(getDay <= 30 && getMonth == cancer[0] && getDay >= cancer[1] || getMonth[0] == cancer[2] && getDay <= cancer[3] ){
        result.innerHTML = `<p style="font-size: 20px; font-weight: bold;">Cancer ${'<br>'} Jun 21 - Jul 22</p>`;
        more.innerHTML = `
        ...
        ${'<br>'}${'<br>'}
        <h5 style="font-weight: bold; font-style: italic;">In the Tarot:</h5>
...
const forLeo =()=>{
    ...
    if(getDay <= 31 && getMonth == leo[0] && getDay >= leo[1] || getMonth[0] == leo[2] && getDay <= leo[3] ){
        result.innerHTML = `<p style="font-size: 20px; font-weight: bold;">Leo ${'<br>'} Jul 23 - Aug 22</p>`;
        more.innerHTML = `
...
const forVirgo =()=>{
    ...
    if(getDay <= 31 && getMonth == virgo[0] && getDay >= virgo[1] || getMonth[0] == virgo[2] && getDay <= 31 && getDay <= virgo[3] ){
        result.innerHTML = `<p style="font-size: 20px; font-weight: bold;">Virgo ${'<br>'} Aug 23 - Sept 22</p>`;
        more.innerHTML = `
...
const forLibra =()=>{
    ...
    if(getDay <= 30 && getMonth == libra[0] && getDay >= libra[1] || getMonth[0] == libra[2] && getDay <= libra[3] ){
        result.innerHTML = `<p style="font-size: 20px; font-weight: bold;">Libra ${'<br>'} Sept 23 - Oct 22</p>`;
        more.innerHTML = `
...
const forScorpio =()=>{
    ...
    if(getDay <= 31 && getMonth ==scorpio[0] && getDay >= scorpio[1] || getMonth[0] == scorpio[2] && getDay <= scorpio[3] ){
        result.innerHTML = `<p style="font-size: 20px; font-weight: bold;">Scorpio${'<br>'} Oct 23 - Nov 21</p>`;
        more.innerHTML = `
...
const forSagittarius =()=>{
    ...
    if(getDay <= 30 && getMonth == sagittarius[0] && getDay >= sagittarius[1] || getMonth[0] == sagittarius[2] && getDay <= sagittarius[3] ){
        result.innerHTML = `<p style="font-size: 20px; font-weight: bold;">Sagittarius${'<br>'} Nov 22 - Dec 21</p>`; 
        more.innerHTML = `
...
const forCapricorn =()=>{
    ...
    if(getDay <= 31 && getMonth == capricorn[0] && getDay >= capricorn[1] || getMonth[0] == capricorn[2] && getDay <= capricorn[3] ){
        result.innerHTML = `<p style="font-size: 20px; font-weight: bold;">Capricorn${'<br>'} Dec 22 - Jan 19</p>`; 
        more.innerHTML = `
...
const forAquarius =()=>{
    ...
    if(getDay <= 31 && getMonth == aquarius[0] && getDay >= aquarius[1] || getMonth[0] == aquarius[2] && getDay <= aquarius[3] ){
        result.innerHTML = `<p style="font-size: 20px; font-weight: bold;">Aquarius${'<br>'} Jan 20 - Feb 18</p>`; 
        more.innerHTML = `
...
const forPisces =()=>{
    ...
    if(getDay <= 29 && getMonth == pisces[0] && getDay >= pisces[1] || getMonth[0] == pisces[2] && getDay <= pisces[3] ){
        result.innerHTML = `<p style="font-size: 20px; font-weight: bold;">Pisces${'<br>'} Feb 19 - Mar 20</p>`; 
        more.innerHTML = `
